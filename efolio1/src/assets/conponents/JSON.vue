    ...
    <section class="lab-section">
      ...
      <ul>
        <li
          ...
          :key="author.id"
          :class="{ highlight: author.id === austen?.id }"
        >
          {{ author.name }} ({{ author.birthYear }})
        </li>
      </ul>
...
import authors from 'C:/Users/10542/qgao-library/src/assets/json/authors.json'
import bookstores from 'C:/Users/10542/qgao-library/src/assets/json/bookstores.json'
